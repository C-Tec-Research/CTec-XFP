...
namespace Xfp.ViewModels.PanelTools
{
    class CausesAndEffectsItemViewModel : ViewModelBase, IPanelToolsViewModel
    {
        ...
        private string getActionTypeString(int index) => Enums.CEActionTypesToString((CEActionTypes)index);
        ...
        private string getTriggerTypeString(int index) => Enums.CETriggerTypesToString((CETriggerTypes)index);

        private string getTriggerParamString(int index)
        {
            try
            {
        ...
        private string getResetTypeString(int index) => Enums.CETriggerTypesToString((CETriggerTypes)_data.ResetType);

        private string getResetParamString(int index)
        {
            try
            {
        ...
        public int SelectedActionTypeIndex    => (int)_data.ActionType;
        public int SelectedActionParamIndex   => _data.TriggerParam + 1;
        public int SelectedTriggerTypeIndex   => (int)_data.TriggerType + 1;
        public int SelectedTriggerParamIndex  => _data.TriggerParam + 1;
        public int SelectedTriggerParam2Index => _data.TriggerParam2 + 1;
        public int SelectedResetTypeIndex     => (int)_data.ResetType + 1;
        public int SelectedResetParamIndex  => _data.ResetParam + 1;
        public int SelectedResetParam2Index => _data.ResetParam2 + 1;


        public string SelectedActionType
        {
            get => getActionTypeString((int)_data.ActionType);
            set
            {
        ...
        public string SelectedActionParam
        {
            get
            {
                ...
                return getActionParamString(_data.ActionParam + 1);
            }
            set
            {
        ...
        {
            get => getTriggerTypeString((int)_data.TriggerType);
            set
            {
        ...
        public string SelectedTriggerParam2
        {
            get
            {
                ...
                //}
                //catch { return ""; }
                return getTriggerParamString(_data.TriggerParam2 + 1);
            }
            set
            {
        ...
        { 
            get => getResetTypeString((int)_data.ResetType);
            set
            {
        ...
        public string SelectedResetParam
        {
            get
            {
                ...
                //}
                //catch { return ""; }
                return getResetParamString(_data.ResetParam + 1);
            }
            set
            {
        ...
        public string SelectedResetParam2
        {
            get
            {
                ...
                //}
                //catch { return ""; }
                return getResetParamString(_data.ResetParam2 + 1);
            }
            set
            {
        ...
        public void RefreshView()
        {
            ...
            var rp = SelectedResetParamIndex;
            ...
            SelectedActionType    = getActionTypeString(at);
            SelectedActionParam   = getActionParamString(ap);
            SelectedTriggerType   = getTriggerTypeString(tt);
            SelectedTriggerParam  = getTriggerParamString(tp);
            SelectedTriggerParam2 = getTriggerParamString(t2);
            SelectedResetType     = getResetTypeString(rt);
            SelectedResetParam    = getResetParamString(tp);
            SelectedResetParam2   = getResetParamString(t2);
