...
namespace Xfp.DataTypes.PanelData
{
    public partial class ZoneConfigData : ConfigData, IConfigData
    {
        ...
        public static string GetZoneName(int? index, bool zeroIsCE = false) => index == 0 && zeroIsCE ? Cultures.Resources.Use_In_Special_C_And_E : string.Format(Cultures.Resources.Zone_x, index is not null ? index : "...");
